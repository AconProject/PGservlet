...
public class ReviewService {
	...
	/*
	 * public PageDTO selectAllPage(int curPage) { SqlSession session =
	 * MySqlSessionFactory.getSession(); PageDTO pDTO = null; try { pDTO =
	 * dao.selectAllPage(session, curPage); } finally { session.close(); } return
	 * pDTO; }
	 */
	/////// 댓글 삽입////////
