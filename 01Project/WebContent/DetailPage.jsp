...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="main-contents">
			<div class="gamename"><h1>After Alpha<small>(2021)</small></h1></div>
			<div class="container">
				<div>
					<table class="topTable">
						<tr>
							...
							<td rowspan="2"><div class="score">95.5</div></td>
						</tr>
						<tr>
							<td><p class="content">“SCUM is a next generation, story driven survival game featuring extremely complex game mechanics and unrevealed survival features. 
			...
			<div class="container">
				<div>
					...
					<table class="reviewTable">
						<tr>
							<td rowspan="2" class="mbrName">내 닉네임</td>
